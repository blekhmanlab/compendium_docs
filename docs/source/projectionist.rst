...
At that point, we need to perform the [robust centered log-ratio transformation](https://journals.asm.org/doi/10.1128/msystems.00016-19). This is how they define it:
